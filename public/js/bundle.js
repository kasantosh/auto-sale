...
var showAlert = function showAlert(type, msg, btn) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\"><img class=\"alert-icon\" src=\"/img/icons/").concat(type, "-icon.png\"><p class=\"alert-msg\">").concat(msg, "</p></div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully"), "".concat(type));
            }
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, alert) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Thank you! You have signed up.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"postAdData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.postAdData = void 0;
...
// type is either password or data
var postAdData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, type) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Posted ad to website successfully", "".concat(type));
              window.setTimeout(function () {
  ...
  return function postAdData(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.postAdData = postAdData;
...
var _postAdData = require("./postAdData");

// DOM ELEMENTS
var loginForm = document.querySelector('.form--login');
var logOutBtn = document.querySelector('.main-section-nav-logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var userSignupForm = document.querySelector('.form-signup');
var postAd = document.querySelector('.form-postad'); // VALUES
// DELEGATION
...
if (postAd) {
  postAd.addEventListener('submit', function (e) {
    e.preventDefault();
    console.log('Post Ad clicked ...');
    var postAdForm = new FormData();
    ...
    var bType = document.getElementById('body-type');
    var bTypeValue = bType.options[bType.selectedIndex].value;
    postAdForm.append('bodyType', bTypeValue);
    var fType = document.getElementById('fuel-type');
    var fTypeValue = fType.options[fType.selectedIndex].value;
    postAdForm.append('fuelType', fTypeValue);
    var dType = document.getElementById('drive-type');
    var dTypeValue = dType.options[dType.selectedIndex].value;
    postAdForm.append('driveType', dTypeValue);
    var transType = document.getElementById('transmission');
    var transTypeValue = transType.options[transType.selectedIndex].value;
    postAdForm.append('transmission', transTypeValue);
    var passNo = document.getElementById('passengers');
    var passNoValue = passNo.options[passNo.selectedIndex].value;
    ...
    for (var i = 0; i < 5; i++) {
      if (document.getElementById("image-".concat(i + 1)).files[0]) postAdForm.append('image', document.getElementById("image-".concat(i + 1)).files[0]);
    }

    (0, _postAdData.postAdData)(postAdForm, 'data');
  });
}
},{"./login":"login.js","./updateSettings":"updateSettings.js","./signup":"signup.js","./postAdData":"postAdData.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
